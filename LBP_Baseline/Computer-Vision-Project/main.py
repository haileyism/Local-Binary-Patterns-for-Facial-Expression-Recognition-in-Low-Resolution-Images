...
def main():
	...
	parser.add_argument('--dataset', dest='dataset', type=str, default='FER2013', help='Main folder of the dataset')
	...
	for xfp in tqdm(xFilepaths, desc="Processing images"):
		img = imgRead(xfp)
		cannot_reshape = 0
	...
	print("Number of samples per class after SMOTE:", Counter(yTrain_res))
